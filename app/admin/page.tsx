...
export default async function AdminPage({
  ...
  return (
    <div className="mx-auto min-h-full w-full max-w-4xl px-3 py-5 pb-[max(1.5rem,env(safe-area-inset-bottom))] sm:px-4 sm:py-8">
      ...
      <section className="mb-6 rounded-xl border border-slate-200 bg-white p-4 shadow-sm sm:mb-8 sm:rounded-2xl sm:p-6">
                    ...
                    <div className="min-w-0 flex-1 space-y-3">
                      ...
                      >
                        ...
                        <div className="min-w-0 flex-1">
                          <label className="ui-label" htmlFor={`image-${p.id}`}>
                            更换图片
                          </label>
                          <input
                            id={`image-${p.id}`}
